...
public class ReflectUtils {
    ...
    static {
        ...
        try {
            ...
            try {
                ...
                Utils.setAccessible(defineClass);
                ...
                defineClassUnsafe = u.getMethod("defineClass", String.class,
    ...
    public static Signature getSignature(Member member) {
        if (member instanceof Method) {
            return new Signature(member.getName(),
                    Type.getMethodDescriptor((Method)member));
        } else if (member instanceof Constructor) {
            Type[] types =
                    TypeUtils.getTypes(((Constructor)member).getParameterTypes());
    ...
    public static Constructor findConstructor(String desc, ClassLoader loader) {
        try {
            ...
            return getClass(className, loader).getConstructor(parseTypes(desc
                    , loader));
    ...
    private static Class getClass(String className, ClassLoader loader,
        ...
        StringBuffer brackets =
                new StringBuffer(className.length() - dimensions);
    ...
    public static Constructor getConstructor(Class type,
        ...
        try {
            ...
            Utils.setAccessible(constructor);
            return constructor;
        } catch (NoSuchMethodException e) {
            throw new CodeGenerationException(e);
        }
    ...
    public static Method findNewInstance(Class iface) {
        ...
        if (!m.getName().equals("newInstance")) {
            throw new IllegalArgumentException(iface + " missing newInstance "
                                               + "method");
        }
        return m;
    }
    ...
    public static Class defineClass(String className, byte[] b,
        ...
        if (DEFINE_CLASS != null) {
            ...
            Object[] args = new Object[]{className, b, 0, b.length, loader,
                    protectionDomain};
    ...
    public static ClassInfo getClassInfo(final Class clazz) {
        ...
        final Type sc = (clazz.getSuperclass() == null) ? null :
                        Type.getType(clazz.getSuperclass());
    ...
    public static Method[] findMethods(String[] namesAndDescriptors,
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            map.put(method.getName() + Type.getMethodDescriptor(method),
                    method);
        }
