...
import org.elite.eval.seq.DelaySeq;
import org.elite.eval.seq.FilteredSeq;
import org.elite.eval.seq.Map2Seq;
import org.elite.eval.seq.MappedSeq;
import org.elite.eval.seq.MappendSeq;
...
public final class Builtin {
   ...
   */
  @Expando
  public static void step(ELContext elctx, Object a, Object b, Object i,
                          Closure p) {
    int arity = p.arity(elctx);
   ...
   */
  public static Annotation annotation(ELContext elctx, Closure var,
                                      String type) {
   ...
   */
  @Expando
  public static void attach(ELContext elctx, Class<?> cls, String name,
                            Closure closure) {
   ...
   */
  @Expando
  public static Object populate(ELContext elctx, Object base,
                                Map<?,?> properties) {
  ...
  private static class StepUp extends DelaySeq {
    ...
    public int size() {
      if (a instanceof Number && b instanceof Number && i instanceof Number) {
        ...
        return coerceToInt(
          __div__(elctx, __add__(elctx, __sub__(elctx, b, a), i), i));
      } else {
        return super.size();
      }
    }
   ...
   */
  @Expando(scope = {EXPANDO, GLOBAL})
  public static Object toArray(ELContext elctx, Collection<?> c,
                               Class<?> type) {
    int size = c.size();
  ...
  private static String map_string(ELContext elctx, CharSequence str,
                                   Closure proc) {
  ...
  private static Object map_set(ELContext elctx, Set<Object> set,
                                Closure proc) {
  ...
  private static String map2_string(ELContext elctx, CharSequence a,
                                    CharSequence b, Closure proc) {
  ...
  private static Object map2_array(ELContext elctx, Object[] a, Object[] b,
                                   Closure proc) {
  ...
  private static String filter_string(ELContext elctx, CharSequence str,
                                      Closure pred) {
    StringBuilder buf = new StringBuilder();
    for (int i = 0, len = str.length(); i < len; i++) {
      char c = str.charAt(i);
  ...
  private static Set<Object> filter_set(ELContext elctx, Set<Object> set,
                                        Closure pred) {
    Set<Object> r = new LinkedHashSet<>();
    for (Object o : set) {
  ...
  @Expando(name = {"foldl", "foldLeft", "fold", "reduce"}, scope = {EXPANDO,
    GLOBAL})
  public static Object foldl(ELContext elctx, Object lst, Object init,
                             Closure proc) {
  ...
  public static Object foldr(ELContext elctx, Object lst, Object end,
                             Closure proc) {
  ...
  private static Object seq_foldr(ELContext elctx, Seq seq, Object end,
                                  Closure proc) {
    if (seq.isEmpty()) {
      return end;
    } else {
  ...
  public static Object fold2(ELContext elctx, Object a, Object b, Object z,
                             Closure p) {
   ...
   */
  @Expando(scope = {EXPANDO, GLOBAL})
  public static Collection<Object> sort(ELContext elctx, Collection<Object> c,
                                        Closure comp) {
    Object[] a = c.toArray();
  ...
  @Expando(name = "<<")
  public static Object __lshift__(Appendable lhs, Object rhs)
    throws IOException {
  ...
  @Expando(name = "-=")
  public static Collection<Object> __isub__(Collection<Object> lhs,
                                            Object rhs) {
    if (rhs instanceof Collection) {
  ...
  @Expando(name = "`|")
  public static Collection<Object> __union__(Collection<Object> lhs,
                                             Collection<Object> rhs) {
  ...
  @Expando(name = "`|=")
  public static Collection<Object> __iunion__(Collection<Object> lhs,
                                              Collection<Object> rhs) {
  ...
  @Expando(name = "`&")
  public static Collection<Object> __intersect__(Collection<Object> lhs,
                                                 Collection<Object> rhs) {
    if (lhs instanceof SortedSet) {
      lhs = new TreeSet<>(lhs);
      lhs.retainAll(rhs);
  ...
  @Expando(name = "`&=")
  public static Collection<Object> __iintersect__(Collection<Object> lhs,
                                                  Collection<Object> rhs) {
    lhs.retainAll(rhs);
    return lhs;
  }
  ...
  private static Comparator<Object> make_comparator(final ELContext elctx,
                                                    final Closure comp) {
