...
public final class Token {
  ...
  public static final int CMP             = 1 + GE;           // x <=> y
  public static final int SHL             = 1 + CMP;          // x<<y
  ...
  public static final String[] opNames = {
    ...
    "&&", "`|", "`^", "`&", "==", "!=", "===", "!==", "<", ">", "<=", ">=",
    "<=>", "<<", ">>", ">>>", "~", "+", "-", "*", "/", "div", "%", "^",
    "instanceof", "in", "not", "`!", "+", "-", "++", "--", "empty", "->",
    "()", ".", "[]", "apply", "new", "literal", "ident", "const", "boolean",
    "char", "number", "symbol", "string", "class", "array", "cons", "nil",
    "tuple", "map", "..", "ast", "xml fragment", "lambda", "metadata",
    "metaset", "public", "protected", "private", "static", "final",
    "abstract", "synchronized", "true", "false", "null", "void", ":", "::",
    "?", "(", ")", "[", "]", "{", "}", "|", "&", "@", "#", "=>", "...", ",",
    ";", "require", "import", "module", "grammar", "define", "class",
    "extends", "implements", "let", "compound", "if", "else", "for",
    "while", "switch", "case", "case", "default", "break", "continue",
    "return", "throw", "try", "catch", "finally", "assert", "LALR"
  };
