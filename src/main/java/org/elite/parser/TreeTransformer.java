...
public class TreeTransformer extends ELNode.Visitor {
  ...
  public void visit(ELNode.LAMBDA e) {
    ...
    if (name == e.name && rtype == e.rtype && vars == e.vars && body == e.body)
      ...
      result = new ELNode.LAMBDA(e.pos, e.file, name, rtype, vars, e.varargs,
                                 body);
  }
  ...
  public void visit(ELNode.CLASSDEF e) {
    ...
    if (id == e.id && base == e.base && ifaces == e.ifaces && vars == e.vars &&
        cvars == e.cvars && ivars == e.ivars)
      result = e;
    else
      result = new ELNode.CLASSDEF(e.pos, e.file, id, base, ifaces, vars, cvars,
                                   ivars);
  }
  ...
  public void visit(ELNode.XFORM e) {
    ...
    ELNode right = transform(e.right);
    if (left instanceof ELNode.TUPLE t)
      result = new ELNode.APPLY(e.pos, right, t.elems, null);
    else
      result = new ELNode.APPLY(e.pos, right, new ELNode[]{left}, null);
  }
  ...
  public void visit(ELNode.ARRAY e) {
    ...
    ELNode.TUPLE init = (ELNode.TUPLE)transform(e.init);
  ...
  public void visit(ELNode.XML e) {
    ...
    if (tag == e.tag && keys == e.keys && values == e.values &&
        children == e.children)
      result = e;
    else
