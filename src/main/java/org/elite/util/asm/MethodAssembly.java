...
public class MethodAssembly
{
    ...
    public MethodAssembly INVOKEVIRTUAL(String owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKEVIRTUAL, owner, name, returnType, argumentTypes);
    }

    public MethodAssembly INVOKEVIRTUAL(Class owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKEVIRTUAL, owner, name, returnType, argumentTypes);
    }
    ...
    public MethodAssembly INVOKESPECIAL(String owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKESPECIAL, owner, name, returnType, argumentTypes);
    }

    public MethodAssembly INVOKESPECIAL(Class owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKESPECIAL, owner, name, returnType, argumentTypes);
    }
    ...
    public MethodAssembly INVOKESTATIC(String owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKESTATIC, owner, name, returnType, argumentTypes);
    }

    public MethodAssembly INVOKESTATIC(Class owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKESTATIC, owner, name, returnType, argumentTypes);
    }
    ...
    public MethodAssembly INVOKEINTERFACE(String owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKEINTERFACE, owner, name, returnType, argumentTypes);
    }

    public MethodAssembly INVOKEINTERFACE(Class owner, String name, Class returnType, Class... argumentTypes) {
        return invoke(INVOKEINTERFACE, owner, name, returnType, argumentTypes);
    }
    ...
    public MethodAssembly TABLESWITCH(int min, int max, Label targets[], Label dflt) {
    ...
    public MethodAssembly TryCatchBlock(Label start, Label end, Label handler, String type) {
        impl.visitTryCatchBlock(start, end, handler, AsmType.toInternalName(type));
        return this;
    }

    public MethodAssembly TryCatchBlock(Label start, Label end, Label handler, Class type) {
        impl.visitTryCatchBlock(start, end, handler, AsmType.toInternalName(type));
        return this;
    }
