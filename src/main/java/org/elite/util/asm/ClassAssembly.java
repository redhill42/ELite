...
public class ClassAssembly {
  ...
  public ClassAssembly(int access, String name, String superName,
                       String[] interfaces) {
    this.className = name;
  ...
  public AnnotationAssembly ANNOTATION(String descriptor, boolean visible) {
    return new AnnotationAssembly(null,
                                  impl.visitAnnotation(descriptor, visible));
  }

  public AnnotationAssembly ANNOTATION(Class<?> type, boolean visible) {
    return new AnnotationAssembly(null, impl.visitAnnotation(
      AsmType.getDescriptor(type), visible));
  }
  ...
  void addClassLiteralField(String name) {
    if (!classLiteralFields.contains(name)) {
      FieldVisitor fw = impl.visitField(ACC_STATIC, name, "Ljava/lang/Class;",
                                        null, null);
      fw.visitEnd();
