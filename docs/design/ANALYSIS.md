...
- 内部类包括：`LAMBDA`, `BLOCK`, `IDENT`, `ACCESS`, `APPLY`, `XFORM`, `ASSIGN`, `ASSIGNOP`, `COND`, `COALESCE`, `OR`, `AND`, `EQ`, `NE`, `LT`, `LE`, `GT`, `GE`, `IN`, `INSTANCEOF`, `PREFIX`, `INFIX`, `THEN`, `BITOR`, `BITAND`, `XOR`, `SHL`, `SHR`, `USHR`, `Composite`, `DEFINE`, `CLASSDEF`, `UNDEF`, 等等
