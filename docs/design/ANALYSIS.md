...
- 内部类包括：`LAMBDA`, `BLOCK`, `IDENT`, `ACCESS`, `APPLY`, `ASSIGN`, `ASSIGNOP`, `COND`, `COALESCE`, `OR`, `AND`, `EQ`, `NE`, `LT`, `LE`, `GT`, `GE`, `IN`, `INSTANCEOF`, `PREFIX`, `INFIX`, `BITOR`, `BITAND`, `XOR`, `SHL`, `SHR`, `USHR`, `Composite`, `DEFINE`, `CLASSDEF`, 等等
